...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "cancel": "Cancel",
        "cluster": "Cluster",
        "show_calls_edges": "Show calls edges",
        "show_raw_json": "Show raw JSON",
        "hide_raw_json": "Hide raw JSON",
        "jump_to_diagnostic": "Jump to diagnostic",
        "expand": "Expand",
        "collapse": "Collapse",
    ...
    "ko": {
        ...
        "cancel": "취소",
        "cluster": "클러스터",
        "show_calls_edges": "calls 엣지 표시",
        "show_raw_json": "Raw JSON 보기",
        "hide_raw_json": "Raw JSON 숨기기",
        "jump_to_diagnostic": "진단 위치로 이동",
        "expand": "펼치기",
        "collapse": "접기",
